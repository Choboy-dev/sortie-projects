...
function FooterLink({
  ...
  return (
    <a
      href={href}
      className="text-base leading-7 text-chalk/80 transition-colors hover:text-chalk"
    >
      {children}
    </a>
  );
    ...
    <footer className="bg-ink text-chalk">
      <div className="mx-auto w-full max-w-7xl px-6 pb-10 pt-16 sm:px-8 sm:pt-20">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.6fr_0.9fr] lg:gap-12 xl:gap-16">
          <div>
            <p className="text-base font-semibold tracking-tight text-chalk">
              Hire Talent
            </p>
        ...
        <div className="mt-14 border-t border-chalk/15 pt-8 sm:mt-16">
          <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              ...
              />
              <p className="text-base text-chalk/75 sm:border-l sm:border-chalk/20 sm:pl-4">
      ...
      <div className="border-t border-chalk/10">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-3 px-6 py-5 text-center text-sm text-chalk/60 sm:flex-row sm:justify-center sm:gap-0 sm:px-8">
